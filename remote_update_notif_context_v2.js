...
async function updateVps() {
    const localPath = path.join(__dirname, 'NotificationContext_vps.js');
...
`;
    ...
    try {
        ...
        await ssh.putFile(localPath, '/var/www/man2man/frontend/context/NotificationContext.js');
        console.log('✅ Updated NotificationContext.js on VPS');
        ssh.dispose();
    } catch (err) {
