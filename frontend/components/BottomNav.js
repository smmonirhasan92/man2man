        ...
        <>
            ...
            <div className={`fixed inset-x-0 bottom-0 z-40 transition-transform duration-500 rounded-t-3xl bg-[#111] border-t border-amber-500/20 shadow-[0_-10px_40px_rgba(0,0,0,0.8)] p-6 pb-32 ${isMenuOpen ? 'translate-y-0' : 'translate-y-full'}`}>
                ...
                <div className="grid grid-cols-4 gap-6">
                    ...
                    <Link href="/dashboard/invest" className="flex flex-col items-center gap-3 text-zinc-400 hover:text-emerald-400 transition-colors group">
                        <div className="w-14 h-14 rounded-2xl bg-zinc-900 flex items-center justify-center border border-zinc-800 group-hover:border-emerald-500/50 shadow-lg group-hover:shadow-emerald-500/10 transition-all"><Zap className="w-6 h-6" /></div>
                        <span className="text-[10px] font-bold tracking-widest uppercase">Invest</span>
                    </Link>
                </div>
            </div>
