                                    ...
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <div className="text-[10px] text-[#848e9c] mt-0.5">
                                                Total: {((trade.amount / 50) * (trade.orderId?.rate || 120)).toLocaleString('en-IN')} {trade.orderId?.fiatCurrency || 'BDT'}
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex justify-between items-start mb-3">
                                        <div className="flex flex-col gap-1.5">
                                            <div className="text-lg font-black font-mono text-[#eaeaec] leading-none">
                                                {order.rate || 120} <span className="text-[10px] text-[#848e9c] ml-0.5">{order.fiatCurrency || 'BDT'} / USD</span>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-2 text-[10px]">
                                                ...
                                                <span className="text-[#eaeaec] font-mono">{((order.amount / 50) * (order.rate || 120)).toLocaleString('en-IN')} {order.fiatCurrency || 'BDT'}</span>
                                            </div>
                                        </div>
