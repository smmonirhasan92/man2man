            ...
            <div className="relative z-10 flex-1 flex flex-col justify-center items-center px-6 pt-12 pb-12">
                ...
                <div className="w-full max-w-md card-glass p-8 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <div className="flex items-center justify-between mb-8 border-b border-white/5 pb-4">
                        <h2 className="text-lg font-bold text-slate-200">System Entry</h2>
                        <span className="px-3 py-1 bg-white/5 rounded-full text-[10px] font-black text-slate-400 border border-white/10 uppercase tracking-widest">Global v2.4.0</span>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div className="flex justify-between items-center text-[11px] px-2">
                            ...
                            <button type="button" onClick={() => toast.error("Contact Support.")} className="text-red-500/80 hover:text-red-400 font-bold underline underline-offset-4">Forgot Access?</button>
                        </div>
                ...
                <div className="mt-10 flex flex-col items-center gap-4">
                    <p className="text-slate-500 text-xs font-medium">Digital Assets Protected by USA-M2M Protocols.</p>
                    <Link href="/register" className="flex items-center gap-3 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl transition-all hover:scale-[1.02] active:scale-[0.98]">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">New Operator?</span>
