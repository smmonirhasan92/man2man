                        ...
                        >
                            ...
                            <div className="text-right">
                                <div className="text-xl font-bold text-slate-900">
                                    {plan.unlock_price > 0 ? `${plan.unlock_price} NXS` : 'Free'}
                                </div>
                    ...
                    >
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="text-xs font-bold text-slate-500 uppercase">Reward (NXS)</label>
                                    <input
                                        type="number"
                                        step="0.01"
                                        required
                            ...
                            <div>
                                <label className="text-xs font-bold text-slate-500 uppercase">Price (NXS)</label>
                                <input
                                    type="number"
                                    step="0.01"
                                    required
