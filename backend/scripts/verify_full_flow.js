...
const LOG_FILE = 'api_full_flow_logs.json';
...
async function runTest() {
    console.log("🚀 STARTING STAGE 2: FULL API FLOW VERIFICATION...");
    ...
    try {
        ...
        const adminIncomeStart = adminBal1.data.income_balance || 0; // CORRECT KEY
        ...
        const userMainStart = userBal1.data.wallet_balance; // CORRECT KEY
