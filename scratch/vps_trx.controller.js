...
exports.getPendingTransactions = async (req, res) => {
    try {
        ...
        // SMARTER FIX: Only auto-expire DEPOSITS (add_money, recharge). 
        // NEVER auto-expire WITHDRAWALS/FEES, because their money is already deducted and needs manual admin Action (Approve/Reject to refund).
